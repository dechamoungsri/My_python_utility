...
list_file = '/home/h1/decha/Dropbox/Inter_speech_2016/Syllable_data/Manual_labeling_stress_unstress/raw/stress_unstressed_label_file_index.txt'
...
src_path = '/home/h1/decha/data/TrainingData/STRIGHT/16k/STRAIGHT_train/script/bap/'
# src_path = '/home/h1/decha/data/vatayaData/labels/mono/'
dest_path = '/work/w2/decha/Data/GPR_data/label/09_stress_manual_labeling/bap/'
# dest_path = '/work/w2/decha/Data/GPR_data/label/09_stress_manual_labeling/mono/'
...
for line in files:
    ...
    if match:
       ...
       dest = '{}/{}/{}/{}/{}{}{}{}.{}'.format(dest_path, tsc, sd, sett, tsc,sd,sett,index,file_format)
       print dest
